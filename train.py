...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "datasets/mydata_trainB/aaa.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default=ROOT / "data/hyps/hyp.scratch-low.yaml", help="hyperparameters path")
    parser.add_argument("--epochs", type=int, default=250, help="total training epochs")
    parser.add_argument("--batch-size", type=int, default=35, help="total batch size for all GPUs, -1 for autobatch")
    ...
    parser.add_argument("--device", default="0,1,2,3,4", help="cuda device, i.e. 0 or 0,1,2,3 or cpu")
